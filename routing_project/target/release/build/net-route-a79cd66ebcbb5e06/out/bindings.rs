...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rt_msghdr_prelude"][::std::mem::size_of::<rt_msghdr_prelude>() - 2usize];
    ["Alignment of rt_msghdr_prelude"][::std::mem::align_of::<rt_msghdr_prelude>() - 2usize];
    ["Offset of field: rt_msghdr_prelude::rtm_msglen"]
        [::std::mem::offset_of!(rt_msghdr_prelude, rtm_msglen) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: ifreq__bindgen_ty_1::ifru_peer_egress_functional_type"]
        [::std::mem::offset_of!(ifreq__bindgen_ty_1, ifru_peer_egress_functional_type) - 0usize];
    ["Offset of field: ifreq__bindgen_ty_1::ifru_is_directlink"]
        [::std::mem::offset_of!(ifreq__bindgen_ty_1, ifru_is_directlink) - 0usize];
    ["Offset of field: ifreq__bindgen_ty_1::ifru_is_vpn"]
        [::std::mem::offset_of!(ifreq__bindgen_ty_1, ifru_is_vpn) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
